      ...
      <div className="about--description_content">
        ...
        <ul className="about--description_list">
          <li className="about-bullets">
            <i className="far fa-arrow-alt-circle-right"></i>I Graduated BS ECE
            at FEU Institute of Technology
          </li>
          <li className="about-bullets">
            <i className="far fa-arrow-alt-circle-right"></i>
            Certified Full Stack Developer by Zuitt Incorporated (2019)
          </li>
          <li className="about-bullets">
            <i className="far fa-arrow-alt-circle-right"></i>I Worked as a Front
            End Developer for MPOTECH with job responsibilities of creating
            websites from scratch using HTML/CSS/JS
          </li>
        </ul>
    ...
    >
      ...
      <div className="about--frontend_content">
        ...
        <ul className="about--frontend_list">
          ...
          <li className="about-frontend">
            <i className="far fa-arrow-alt-circle-right"></i>PHP & Laravel
          </li>
